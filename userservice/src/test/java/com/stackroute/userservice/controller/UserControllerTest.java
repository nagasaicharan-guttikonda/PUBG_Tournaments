...
public class UserControllerTest {
	...
	public void testRegisterUser() throws Exception {
		...
		mockMvc.perform(post("/userservice/register").contentType(MediaType.APPLICATION_JSON)
	...
	public void testLoginUser() throws Exception {
		...
		mockMvc.perform(post("/userservice/login").contentType(MediaType.APPLICATION_JSON)
